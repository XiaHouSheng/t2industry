...
// 2. 已删除所有自定义方法（handleOpenDialog/handleRightClick/handleBeltConnect）
</script>
...
<template>
  ...
  >
    ...
    >
      <!-- inner数量 = width=6：所有按钮绑定 machineStore 并补充 gs_id 参数 -->
      <el-button
    ...
    <div
      class="display-flex flex-direation-row justify-content-center"
    >
      <!-- outer数量 = width=6：所有按钮绑定 machineStore 并补充 gs_id 参数 -->
      <el-button
